...
async def run_agent_task(
    ...
    if llm_provider_name == "groq" and use_vision:
        logger.info("Groq selected; disabling vision because the endpoint expects string-only message content here.")
        use_vision = False
    ...
    if planner_llm_provider_name:
        ...
        if planner_llm_provider_name == "groq" and planner_use_vision:
            logger.info("Groq planner selected; disabling planner vision because the endpoint expects string-only message content here.")
            planner_use_vision = False
