...
If you want screenshots to appear in your README:

1. save them inside the repo, for example:
   `assets/`
...
If you want multiple screenshots, place them in `assets/` and add them like:

```md
## Screenshots

![Home UI](./assets/web-ui.png)
```
